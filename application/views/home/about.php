...
<section class="about-featured parallax" style="background:#fafafa;">
    <div class="container px-md-0">
        <h3 class="lite" style="color: #009bdb;"><?php echo $service['title']; ?></h3>
        <h2 class="lite" style="color: #009bdb;">
        ...
        <ul class="list-unstyled list row">
            ...
            ?>
            <li class="col-lg-4 col-md-6 col-sm-12" style="color:#000;">
