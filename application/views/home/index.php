...
<?php
    ...
    ?>
<section class="featured-doctors" style="background:#fafafa;">
    <div class="container px-md-0">
        <div class="sec-title text-center">
            <h2 style="color:#009bdb;"><?php echo $teachers['title'] ?></h2>
            <p  style="color:#8d8d8d;"><?php echo nl2br($teachers['description']); ?></p>
            <span class="decor"><span class="inner"></span></span>
        </div>
        <div class="row">
            <?php
...
<section class="counters-wrapper" style="background: #fff;" >
    <div class="container px-md-0">
        <div class="sec-title text-center">
